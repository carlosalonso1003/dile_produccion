...
export default function FormRapidin() {
  useEffect(() => {
    document.title = "DILE Solicitar Rapidin";
  }, []);
  const slides = [
    {
  ...
  const title =
    "Pide tu crédito rapidin y conoce los beneficios que tenemos para ti";
  return (
    <>
      <MoldeFormulario
        title={title}
        slides={slides}
        labelProducto={"Rapidin"}
      />
    </>
  );
}
