...
export default function FormMasInclusivo() {
  useEffect(() => {
    document.title = "DILE Solicitar Mas Inclusivo";
  }, []);
  const slides = [
    {
  ...
  const title =
    "Pide tu crédito mas inclusivo y conoce los beneficios que tenemos para ti";
  return (
    <>
      <MoldeFormulario
        title={title}
        slides={slides}
        labelProducto={"MasInclusivo"}
      />
    </>
  );
}
