...
export default function FormPagoDiario() {
  useEffect(() => {
    document.title = "DILE Solicitar Pago Diario";
  }, []);
  ...
  const title =
    "Pide tu crédito pago diario y conoce los beneficios que tenemos para ti";
  return (
    <>
      <MoldeFormulario
        title={title}
        slides={slides}
        labelProducto={"PagoDiario"}
      />
    </>
  );
}
